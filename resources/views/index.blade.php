                        ...
                        <div class="rounded-lg shadow-lg bg-gray-600 w-full my-4 flex flex-row flex-wrap p-3 antialiased">
                            ...
                            <div class="md:w-2/3 w-full px-3 flex flex-row flex-wrap">
                                <div class="w-full flex justify-center align-top flex-col text-gray-700 font-semibold relative pt-3 md:pt-0">
                                    <div class="text-2xl text-dark my-3  leading-tight"><span>Name:</span>{{$plant->name}}</div>
                                    <div class="text-2xl text-dark  leading-tight"><span>Species:</span>{{$plant->species}}</div>
                                    <div class="text-2xl text-dark  my-5 leading-tight" style="height: 200px;width: 200px">
